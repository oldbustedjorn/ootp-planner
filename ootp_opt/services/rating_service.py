...
def build_hitter_weights(config: dict[str, Any] | None = None) -> HitterRoleWeights:
    ...
    return HitterRoleWeights(
        ...
        power_midpoint=hitter_cfg.get("power_midpoint"),
        eye_midpoint=hitter_cfg.get("eye_midpoint"),
        gap_midpoint=hitter_cfg.get("gap_midpoint"),
        babip_midpoint=hitter_cfg.get("babip_midpoint"),
        avoid_k_midpoint=hitter_cfg.get("avoid_k_midpoint"),
        babip_floor=hitter_cfg.get("babip_floor"),
        babip_floor_penalty=hitter_cfg.get("babip_floor_penalty", 0.0),
        avoid_k_floor=hitter_cfg.get("avoid_k_floor"),
        avoid_k_floor_penalty=hitter_cfg.get("avoid_k_floor_penalty", 0.0),
...
def build_pitcher_weights(config: dict[str, Any] | None = None) -> PitcherRoleWeights:
    ...
    return PitcherRoleWeights(
        ...
        sp_stuff_midpoint=pitcher_cfg.get("sp_stuff_midpoint"),
        sp_pbabip_midpoint=pitcher_cfg.get("sp_pbabip_midpoint"),
        sp_hr_rate_midpoint=pitcher_cfg.get("sp_hr_rate_midpoint"),
        sp_control_midpoint=pitcher_cfg.get("sp_control_midpoint"),
        sp_control_floor=pitcher_cfg.get("sp_control_floor", pitcher_cfg.get("control_floor")),
        sp_control_floor_penalty=pitcher_cfg.get(
            "sp_control_floor_penalty",
            pitcher_cfg.get("control_floor_penalty", 0.0),
        ),
        ...
        rp_stuff_midpoint=pitcher_cfg.get("rp_stuff_midpoint"),
        rp_pbabip_midpoint=pitcher_cfg.get("rp_pbabip_midpoint"),
        rp_hr_rate_midpoint=pitcher_cfg.get("rp_hr_rate_midpoint"),
        rp_control_midpoint=pitcher_cfg.get("rp_control_midpoint"),
        rp_control_floor=pitcher_cfg.get("rp_control_floor", pitcher_cfg.get("control_floor")),
        rp_control_floor_penalty=pitcher_cfg.get(
            "rp_control_floor_penalty",
            pitcher_cfg.get("control_floor_penalty", 0.0),
        ),
